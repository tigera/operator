...
handle-milestone: hack/bin/gh var-require-all-VERSION-GITHUB_TOKEN
	...
	@gh search prs --milestone $(VERSION) --state open --json id | \
	...
	@echo "Closing $(VERSION) milestone #$(MILESTONE_NUMBER)"
	@gh milestone edit $(MILESTONE_NUMBER) --state closed --repo $(REPO)

release-prep: handle-milestone var-require-all-GIT_PR_BRANCH_BASE-GIT_REPO_SLUG-VERSION-CALICO_VERSION-COMMON_VERSION-CALICO_ENTERPRISE_VERSION
