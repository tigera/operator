...
- Running a managed public cloud? Use our guides for enabling Calico network policies.
  - [Amazon Elastic Kubernetes Service (EKS)](https://docs.tigera.io/calico/3.25/getting-started/kubernetes/managed-public-cloud/eks)
  - [Google Kubernetes Engine (GKE)](https://docs.tigera.io/calico/3.25/getting-started/kubernetes/managed-public-cloud/gke)
