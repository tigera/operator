...
type CalicoKubeControllersDeploymentPodSpec struct {
	...
	// WARNING: Please note that this field will override the operator's default calico-kube-controllers Deployment affinity.
	// +optional
	...
	// WARNING: Please note that this field will override the operator's default calico-kube-controllers Deployment nodeSelector.
	// +optional
	...
	// WARNING: Please note that this field will override the operator's default calico-kube-controllers Deployment tolerations.
	// +optional
