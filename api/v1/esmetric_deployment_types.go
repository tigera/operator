...
// ESMetricsDeploymentSpec defines configuration for the tigera-elasticsearch-metric Deployment.
...
// ESMetricsDeploymentPodTemplateSpec is the tigera-elasticsearch-metric Deployment's PodTemplateSpec
...
// ESMetricsDeploymentPodSpec is the tigera-elasticsearch-metric Deployment's PodSpec.
type ESMetricsDeploymentPodSpec struct {
	// InitContainers is a list of tigera-elasticsearch-metric init containers.
	// If specified, this overrides the specified tigera-elasticsearch-metric Deployment init containers.
	...
	// Containers is a list of tigera-elasticsearch-metric containers.
	// If specified, this overrides the specified tigera-elasticsearch-metric Deployment containers.
...
// ESMetricsDeploymentContainer is a tigera-elasticsearch-metric Deployment container.
type ESMetricsDeploymentContainer struct {
	// Name is an enum which identifies the tigera-elasticsearch-metric Deployment container by name.
	// +kubebuilder:validation:Enum=tigera-elasticsearch-metrics
	Name string `json:"name"`

	// Resources allows customization of limits and requests for compute resources such as cpu and memory.
	// If specified, this overrides the named tigera-elasticsearch-metric Deployment container's resources.
	// If omitted, the esMetrics Deployment will use its default value for this container's resources.
	// +optional
	Resources *v1.ResourceRequirements `json:"resources,omitempty"`
}

// ESMetricsDeploymentInitContainer is a tigera-elasticsearch-metric Deployment init container.
type ESMetricsDeploymentInitContainer struct {
	// Name is an enum which identifies the tigera-elasticsearch-metric Deployment init container by name.
	// +kubebuilder:validation:Enum=tigera-ee-elasticsearch-metrics-key-cert-provisioner
	Name string `json:"name"`

	// Resources allows customization of limits and requests for compute resources such as cpu and memory.
	// If specified, this overrides the named tigera-elasticsearch-metric Deployment init container's resources.
