...
type LogStorageSpec struct {
	...
	// ESGateway defines the configuration for the ES Gateway.
	// +optional
	ESGateway *ESGateway `json:"esgateway,omitempty"`
...
type ESGateway struct {
	// Replicas defines how many ES Gateway replicas in the cluster. Defaults to 2.
	// +optional
	Replicas *int32 `json:"replicas,omitempty"`
}
