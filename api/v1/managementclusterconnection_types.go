...
type ManagementClusterTLS struct {
	...
	//  generated by the Tigera API Server which can be used to verify the tunnel server's identity, and will expect the cert to have
	// a Common Name (CN) of 'voltron'.
	//
