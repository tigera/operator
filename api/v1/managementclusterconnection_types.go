...
type ManagementClusterTLS struct {
	...
	//
	// When left blank or set to 'Tigera', the tunnel client will expect a self-signed cert to be included in the certificate bundle generated by the Tigera API Server which can be used to verify the tunnel server's identity, and will expect the cert to have a Common Name (CN) of 'voltron'.
	//
