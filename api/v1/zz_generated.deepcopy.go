...
func (in *CalicoNetworkSpec) DeepCopyInto(out *CalicoNetworkSpec) {
	*out = *in
	...
	if in.VPP != nil {
		in, out := &in.VPP, &out.VPP
		*out = new(VPPConfiguration)
		**out = **in
	}
	if in.IPPools != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VPPConfiguration) DeepCopyInto(out *VPPConfiguration) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VPPConfiguration.
func (in *VPPConfiguration) DeepCopy() *VPPConfiguration {
	if in == nil {
		return nil
	}
	out := new(VPPConfiguration)
