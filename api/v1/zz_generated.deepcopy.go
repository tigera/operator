...
func (in *EgressGatewayFailureDetection) DeepCopyInto(out *EgressGatewayFailureDetection) {
	*out = *in
	...
	if in.HealthTimeoutDataStore != nil {
		in, out := &in.HealthTimeoutDataStore, &out.HealthTimeoutDataStore
		*out = new(metav1.Duration)
		**out = **in
	}
	if in.ICMPProbes != nil {
		in, out := &in.ICMPProbes, &out.ICMPProbes
		*out = new(ICMPProbes)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HTTPProbes) DeepCopyInto(out *HTTPProbes) {
	*out = *in
	if in.URLs != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HTTPProbes.
func (in *HTTPProbes) DeepCopy() *HTTPProbes {
	if in == nil {
		return nil
	}
	out := new(HTTPProbes)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ICMPProbes) DeepCopyInto(out *ICMPProbes) {
	*out = *in
	if in.IPs != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ICMPProbes.
func (in *ICMPProbes) DeepCopy() *ICMPProbes {
	if in == nil {
		return nil
	}
	out := new(ICMPProbes)
