...
func (in *OTelCollectorSpec) DeepCopyInto(out *OTelCollectorSpec) {
	*out = *in
	...
	if in.OTelCollectorStatefulSet != nil {
		in, out := &in.OTelCollectorStatefulSet, &out.OTelCollectorStatefulSet
		*out = new(OTelCollectorStatefulSet)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OTelCollectorStatefulSet) DeepCopyInto(out *OTelCollectorStatefulSet) {
	*out = *in
	if in.Metadata != nil {
		in, out := &in.Metadata, &out.Metadata
		*out = new(Metadata)
	...
	if in.Spec != nil {
		in, out := &in.Spec, &out.Spec
		*out = new(OTelCollectorStatefulSetSpec)
		(*in).DeepCopyInto(*out)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OTelCollectorStatefulSet.
func (in *OTelCollectorStatefulSet) DeepCopy() *OTelCollectorStatefulSet {
	if in == nil {
		return nil
	}
	out := new(OTelCollectorStatefulSet)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OTelCollectorStatefulSetContainer) DeepCopyInto(out *OTelCollectorStatefulSetContainer) {
	*out = *in
	if in.Resources != nil {
		in, out := &in.Resources, &out.Resources
		*out = new(corev1.ResourceRequirements)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OTelCollectorStatefulSetContainer.
func (in *OTelCollectorStatefulSetContainer) DeepCopy() *OTelCollectorStatefulSetContainer {
	if in == nil {
		return nil
	}
	out := new(OTelCollectorStatefulSetContainer)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OTelCollectorStatefulSetPodSpec) DeepCopyInto(out *OTelCollectorStatefulSetPodSpec) {
	*out = *in
	if in.Affinity != nil {
		in, out := &in.Affinity, &out.Affinity
		*out = new(corev1.Affinity)
	...
	if in.Containers != nil {
		in, out := &in.Containers, &out.Containers
		*out = make([]OTelCollectorStatefulSetContainer, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OTelCollectorStatefulSetPodSpec.
func (in *OTelCollectorStatefulSetPodSpec) DeepCopy() *OTelCollectorStatefulSetPodSpec {
	if in == nil {
		return nil
	}
	out := new(OTelCollectorStatefulSetPodSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OTelCollectorStatefulSetPodTemplateSpec) DeepCopyInto(out *OTelCollectorStatefulSetPodTemplateSpec) {
	*out = *in
	if in.Metadata != nil {
		in, out := &in.Metadata, &out.Metadata
		*out = new(Metadata)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OTelCollectorStatefulSetPodTemplateSpec.
func (in *OTelCollectorStatefulSetPodTemplateSpec) DeepCopy() *OTelCollectorStatefulSetPodTemplateSpec {
	if in == nil {
		return nil
	}
	out := new(OTelCollectorStatefulSetPodTemplateSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OTelCollectorStatefulSetSpec) DeepCopyInto(out *OTelCollectorStatefulSetSpec) {
	*out = *in
	if in.MinReadySeconds != nil {
		in, out := &in.MinReadySeconds, &out.MinReadySeconds
		*out = new(int32)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OTelCollectorStatefulSetSpec.
func (in *OTelCollectorStatefulSetSpec) DeepCopy() *OTelCollectorStatefulSetSpec {
	if in == nil {
		return nil
	}
	out := new(OTelCollectorStatefulSetSpec)
