...
func (in *ApplicationLayerSpec) DeepCopyInto(out *ApplicationLayerSpec) {
	*out = *in
	if in.L7LogCollection != nil {
		in, out := &in.L7LogCollection, &out.L7LogCollection
		*out = new(L7LogCollectionSpec)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *L7LogCollectionSpec) DeepCopyInto(out *L7LogCollectionSpec) {
	*out = *in
	if in.CollectL7Logs != nil {
		in, out := &in.CollectL7Logs, &out.CollectL7Logs
		*out = new(L7LogCollectionStatusType)
		**out = **in
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new L7LogCollectionSpec.
func (in *L7LogCollectionSpec) DeepCopy() *L7LogCollectionSpec {
	if in == nil {
		return nil
	}
	out := new(L7LogCollectionSpec)
