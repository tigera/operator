...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WAFUI) DeepCopyInto(out *WAFUI) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(WAFUIStatusType)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WAFUI.
func (in *WAFUI) DeepCopy() *WAFUI {
	if in == nil {
		return nil
	}
	out := new(WAFUI)
