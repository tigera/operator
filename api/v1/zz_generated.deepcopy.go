...
func (in *Alerts) DeepCopyInto(out *Alerts) {
	*out = *in
	out.DeniedPackets = in.DeniedPackets
	out.TigeraStatus = in.TigeraStatus
	out.TLSCertExpiry = in.TLSCertExpiry
	out.LicenseExpiry = in.LicenseExpiry
	out.IPPoolExhaustion = in.IPPoolExhaustion
}
