...
def main():
    ...
    graph.add_edge(Edge('authentication', 'clusterconnection'))
    ...
    graph.add_edge(Edge('compliance', 'clusterconnection'))
    ...
    graph.add_edge(Edge('intrusiondetection', 'clusterconnection'))
    ...
    graph.add_edge(Edge('logstorage', 'clusterconnection'))
    ...
    graph.add_edge(Edge('manager', 'clusterconnection'))
