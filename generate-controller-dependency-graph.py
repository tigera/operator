...
def main():
    ...
    graph.add_edge(Edge('apiserver', 'amazoncloudintegration', style='dashed'))
    graph.add_edge(Edge('apiserver', 'clusterconnection', style='dashed'))
    ...
    graph.add_edge(Edge('clusterconnection', 'installation'))
    ...
    graph.add_edge(Edge('intrusiondetection',
                   'clusterconnection', style='dashed'))
    ...
    graph.add_edge(Edge('logcollector', 'clusterconnection', style='dashed'))
