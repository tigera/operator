...
require (
	github.com/elastic/cloud-on-k8s v0.0.0-20190729005318-8280d4172234
...
replace github.com/elastic/cloud-on-k8s => github.com/elastic/cloud-on-k8s v0.0.0-20190729005318-8280d4172234
