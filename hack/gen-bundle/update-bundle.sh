...
yq write -i ${CSV} "metadata.annotations.\"${FEATURES}/disconnected\"" "false"
yq write -i ${CSV} "metadata.annotations.\"${FEATURES}/fips-compliant\"" "false"
yq write -i ${CSV} "metadata.annotations.\"${FEATURES}/proxy-aware\"" "false"
yq write -i ${CSV} "metadata.annotations.\"${FEATURES}/tls-profiles\"" "false"
yq write -i ${CSV} "metadata.annotations.\"${FEATURES}/token-auth-aws\"" "false"
yq write -i ${CSV} "metadata.annotations.\"${FEATURES}/token-auth-azure\"" "false"
yq write -i ${CSV} "metadata.annotations.\"${FEATURES}/token-auth-gcp\"" "false"
yq write -i ${CSV} "metadata.annotations.\"${FEATURES}/cnf\"" "false"
yq write -i ${CSV} "metadata.annotations.\"${FEATURES}/cni\"" "true"
yq write -i ${CSV} "metadata.annotations.\"${FEATURES}/csi\"" "false"
