...
const (
	CloudRegistry           = "gcr.io/unique-caldron-775/cnx/"
...
func cloudRegistry(c component, registry, version string) (string, string) {
	if registry == "" || registry == UseDefault {
		...
		case ComponentCloudRBACApi:
			// override cloud rbac api which is always pushed to tigera-tesla
			registry = "gcr.io/tigera-tesla/"
		case ComponentImageAssuranceApiProxy, ComponentImageAssuranceScanner, ComponentImageAssuranceRuntimeCleaner:
