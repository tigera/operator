...
func main() {
	...
	badNamespaces := []string{
		...
		rmeta.APIServerNamespace(operatorv1.Calico),
		render.APIServerNamespace(operatorv1.TigeraSecureEnterprise),
	...
	if _, ok := badNamespaces[common.OperatorNamespace()]; ok {
