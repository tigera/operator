...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AuthorizationOIDC) DeepCopyInto(out *AuthorizationOIDC) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AuthorizationOIDC.
func (in *AuthorizationOIDC) DeepCopy() *AuthorizationOIDC {
	if in == nil {
		return nil
	}
	out := new(AuthorizationOIDC)
	in.DeepCopyInto(out)
	return out
}
