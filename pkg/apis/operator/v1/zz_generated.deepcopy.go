...
func (in *Retention) DeepCopyInto(out *Retention) {
	*out = *in
	if in.FlowRetention != nil {
		in, out := &in.FlowRetention, &out.FlowRetention
		*out = new(int32)
		**out = **in
	}
	if in.AuditReportRetention != nil {
		in, out := &in.AuditReportRetention, &out.AuditReportRetention
		*out = new(int32)
		**out = **in
	}
	...
	if in.ComplianceReportRetention != nil {
		in, out := &in.ComplianceReportRetention, &out.ComplianceReportRetention
		*out = new(int32)
		**out = **in
	}
	return
