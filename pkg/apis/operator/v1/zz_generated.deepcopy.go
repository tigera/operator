...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EksLogForwarderSpec) DeepCopyInto(out *EksLogForwarderSpec) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EksLogForwarderSpec.
func (in *EksLogForwarderSpec) DeepCopy() *EksLogForwarderSpec {
	if in == nil {
		return nil
	}
	out := new(EksLogForwarderSpec)
