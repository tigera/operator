...
func schema_pkg_apis_operator_v1_LogCollectorSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "LogCollectorSpec defines the desired state of Tigera flow and DNS log collection.",
				Properties: map[string]spec.Schema{
					"s3": {
						SchemaProps: spec.SchemaProps{
							Description: "If specified, enables exporting of flow and DNS logs to Amazon S3 storage.",
							Ref:         ref("github.com/tigera/operator/pkg/apis/operator/v1.S3StoreSpec"),
						},
					},
					"syslog": {
						SchemaProps: spec.SchemaProps{
							Description: "If specified, enables exporting of flow and DNS logs to syslog.",
