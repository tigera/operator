...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"github.com/tigera/operator/pkg/apis/operator/v1.AmazonCloudIntegration":          schema_pkg_apis_operator_v1_AmazonCloudIntegration(ref),
		"github.com/tigera/operator/pkg/apis/operator/v1.AmazonCloudIntegrationSpec":      schema_pkg_apis_operator_v1_AmazonCloudIntegrationSpec(ref),
		"github.com/tigera/operator/pkg/apis/operator/v1.AmazonCloudIntegrationStatus":    schema_pkg_apis_operator_v1_AmazonCloudIntegrationStatus(ref),
...
func schema_pkg_apis_operator_v1_AmazonCloudIntegration(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/tigera/operator/pkg/apis/operator/v1.AmazonCloudIntegrationSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/tigera/operator/pkg/apis/operator/v1.AmazonCloudIntegrationStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/tigera/operator/pkg/apis/operator/v1.AmazonCloudIntegrationSpec", "github.com/tigera/operator/pkg/apis/operator/v1.AmazonCloudIntegrationStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_pkg_apis_operator_v1_AmazonCloudIntegrationSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
...
func schema_pkg_apis_operator_v1_AmazonCloudIntegrationStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
