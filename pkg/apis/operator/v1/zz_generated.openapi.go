	...
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "APIServerSpec defines optional configuration for the API server component. Valid only for the variant 'TigeraSecureEnterprise'.",
				Properties: map[string]spec.Schema{
					"extraEnv": {
						SchemaProps: spec.SchemaProps{
							Description: "ExtraEnv adds extra environment variables to the API server.",
							Type:        []string{"array"},
					...
					"extraVolumes": {
						SchemaProps: spec.SchemaProps{
							Description: "ExtraVolumes configures custom volumes to be used by the API server.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
					...
					"extraVolumeMounts": {
						SchemaProps: spec.SchemaProps{
							Description: "ExtraVolumeMounts configures custom volume mounts to be used by the API server.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
					...
					"tolerations": {
						SchemaProps: spec.SchemaProps{
							Description: "Tolerations configures custom tolerations on the API server deployment.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
					...
					"resources": {
						SchemaProps: spec.SchemaProps{
							Description: "Resources configures custom resource requirements on the API server container.",
...
func schema_pkg_apis_operator_v1_ComponentsSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"console": {
						SchemaProps: spec.SchemaProps{
							Description: "Console is optional configuration for the Tigera Secure management console.",
		...
		Dependencies: []string{
			"github.com/tigera/operator/pkg/apis/operator/v1.APIServerSpec", "github.com/tigera/operator/pkg/apis/operator/v1.CNISpec", "github.com/tigera/operator/pkg/apis/operator/v1.ConsoleSpec", "github.com/tigera/operator/pkg/apis/operator/v1.KubeControllersSpec", "github.com/tigera/operator/pkg/apis/operator/v1.NodeSpec"},
	}
}
...
func schema_pkg_apis_operator_v1_DatastoreConfig(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "DatastoreConfig specifies the product's datastore configuration.",
				Properties: map[string]spec.Schema{
					"type": {
						SchemaProps: spec.SchemaProps{
							Description: "Type is the type of datastore to be used. Currently, only Kubernetes API datastore is supported. Default: kubernetes",
							Type:        []string{"string"},
							Format:      "",
						},
					},
...
func schema_pkg_apis_operator_v1_InstallationSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"datastore": {
						SchemaProps: spec.SchemaProps{
							Description: "Datastore is datastore configuration.",
							Ref:         ref("github.com/tigera/operator/pkg/apis/operator/v1.DatastoreConfig"),
						},
					},
					"variant": {
						SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"github.com/tigera/operator/pkg/apis/operator/v1.ComponentsSpec", "github.com/tigera/operator/pkg/apis/operator/v1.DatastoreConfig", "github.com/tigera/operator/pkg/apis/operator/v1.IPPool", "k8s.io/api/core/v1.LocalObjectReference"},
	}
}
