...
var _ = Describe("No registry override", func() {
	...
	It("should render an operator init image correctly", func() {
		Expect(GetOperatorInitReference("", "")).To(Equal(TigeraInitRegistry + "tigera/operator-init:" + ComponentOperatorInit.Version))
	})
})
...
var _ = Describe("imagepath override", func() {
	...
	It("should render an operator init image correctly", func() {
		Expect(GetOperatorInitReference("", "userpath")).To(Equal(TigeraInitRegistry + "userpath/operator-init:" + ComponentOperatorInit.Version))
	})
})
