...
var _ = Describe("No registry override", func() {
	...
	It("should render a tigera image correctly", func() {
		Expect(GetReference(ComponentTigeraNode, "", "")).To(Equal("quay.io/tigera/cnx-node:" + ComponentTigeraNode.Version))
	})
...
var _ = Describe("imagepath override", func() {
	...
	It("should render a tigera image correctly", func() {
		Expect(GetReference(ComponentTigeraNode, "", "userpath")).To(Equal("quay.io/userpath/cnx-node:" + ComponentTigeraNode.Version))
	})
	It("should render an ECK image correctly", func() {
