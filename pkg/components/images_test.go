...
var _ = Describe("test GetReference", func() {
	Context("No registry override", func() {
		...
		It("should render an ECK image correctly", func() {
			Expect(GetReference(ComponentElasticsearchOperator, "", "", "", nil)).To(Equal(TigeraRegistry + "tigera/eck-operator:" + ComponentElasticsearchOperator.Version))
		})
	...
	Context("UseDefault for registry and imagepath", func() {
		...
		It("should render an ECK image correctly", func() {
			Expect(GetReference(ComponentElasticsearchOperator, ud, ud, "", nil)).To(Equal(TigeraRegistry + "tigera/eck-operator:" + ComponentElasticsearchOperator.Version))
		})
		It("should render an operator init image correctly", func() {
	...
	Context("imagepath override", func() {
		...
		It("should render an ECK image correctly", func() {
			Expect(GetReference(ComponentElasticsearchOperator, "", "userpath", "", nil)).To(Equal(TigeraRegistry + "userpath/eck-operator:" + ComponentElasticsearchOperator.Version))
		})
		It("should render an operator init image correctly", func() {
