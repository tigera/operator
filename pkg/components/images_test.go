...
var _ = Describe("test GetReference", func() {
	Context("No registry override", func() {
		DescribeTable("should render",
			...
			Entry("a CSR init image correctly", ComponentCSRInitContainer, CalicoRegistry, "calico/key-cert-provisioner"),
			Entry("a CSR init image correctly", ComponentCSRInitContainerPrivate, TigeraRegistry, "tigera/key-cert-provisioner"),
		)
	})
	...
	Context("registry override", func() {
		DescribeTable("should render",
			...
			Entry("a CSR init image correctly", ComponentCSRInitContainer, "calico/key-cert-provisioner"),
			Entry("a CSR init image correctly", ComponentCSRInitContainerPrivate, "tigera/key-cert-provisioner"),
		)
	})
	...
	Context("image prefix override", func() {
		DescribeTable("should render",
			...
			Entry("a CSR init image correctly", ComponentCSRInitContainer, "calico/pref/key-cert-provisioner"),
			Entry("a CSR init image correctly", ComponentCSRInitContainerPrivate, "tigera/pref/key-cert-provisioner"),
		)
	})
	...
	Context("imagepath override", func() {
		DescribeTable("should render",
			...
			Entry("a CSR init image correctly", ComponentCSRInitContainer, CalicoRegistry, "userpath/key-cert-provisioner"),
			Entry("a CSR init image correctly", ComponentCSRInitContainerPrivate, TigeraRegistry, "userpath/key-cert-provisioner"),
		)
	})
	Context("registry and imagepath override", func() {
		DescribeTable("should render",
			...
			Entry("a CSR init image correctly", ComponentCSRInitContainerPrivate, "userpath/key-cert-provisioner"),
		)
	})
	Context("with an ImageSet", func() {
		DescribeTable("should render",
			...
			Entry("a CSR init image correctly", ComponentCSRInitContainerPrivate, "userpath/key-cert-provisioner", "@sha256:tigerakeycertprovisionerhash"),
		)
	})
})
