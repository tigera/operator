...
func (r *ReconcileConnection) Reconcile(ctx context.Context, request reconcile.Request) (reconcile.Result, error) {
	...
	if managementClusterConnection.Spec.ServerIdentityVerificationMethod == operatorv1.TunnelCertCASigned {
	...
	guardianCfg := &render.GuardianConfiguration{
		...
		TunnelCertType:       managementClusterConnection.Spec.ServerIdentityVerificationMethod,
