...
var _ = Describe("Compliance controller tests", func() {
	...
	BeforeEach(func() {
		...
		Expect(c.Create(ctx, &corev1.Secret{ObjectMeta: metav1.ObjectMeta{Name: render.EsGatewayElasticPublicCertSecret, Namespace: "tigera-operator"}})).NotTo(HaveOccurred())
