...
func (r *ReconcileLogStorage) createEsGateway(
	...
	cfg.CertSecrets = []*corev1.Secret{gatewayCertSecret, publicCertSecret}
	cfg.KubeControllersUserSecrets = []*corev1.Secret{kubeControllersGatewaySecret, kubeControllersVerificationSecret, kubeControllersSecureUserSecret}
	cfg.KibanaInternalCertSecret = kibanaInternalCertSecret
	cfg.EsInternalCertSecret = esInternalCertSecret
