...
func (r *ReconcileLogStorage) generateSecrets(
	...
	for _, certName := range certs {
		...
		if err != nil {
			...
			// used here and with the linseed certs that are created by linseed which this controller
			// deploys.
			// This comes into play during an upgrade when certificates need to be updated and
			// linseed needs to be deployed because it previously did not exist.
