...
func (r *ReconcileLogStorage) Reconcile(ctx context.Context, request reconcile.Request) (reconcile.Result, error) {
	...
	if managementClusterConnection == nil {
		...
		esGatewayComponent := esgateway.EsGateway(ls, install, pullSecrets, esCertSecret, esAdminUserSecret, kibanaInternalCertSecret, esInternalCertSecret, r.clusterDomain)
