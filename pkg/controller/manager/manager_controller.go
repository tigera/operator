...
func (r *ReconcileManager) Reconcile(ctx context.Context, request reconcile.Request) (reconcile.Result, error) {
	...
	complianceFeatureActive := utils.IsFeatureActive(license, common.ComplianceFeature)
	...
	if complianceFeatureActive && complianceCR != nil {
	...
	managerCfg := &render.ManagerConfiguration{
		...
		ComplianceLicenseFeatureActive: complianceFeatureActive,
		UsePSP:                         r.usePSP,
	}
