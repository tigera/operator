...
// NeedsInstallationConversion checks if an existing installation of Calico exists which
// is not managed by the Operator.
func NeedsInstallationConversion(ctx context.Context, client client.Client) (bool, error) {
...
// ConvertInstallation updates an Installation resource based on an existing Calico install (i.e.
...
func ConvertInstallation(ctx context.Context, client client.Client) (*operatorv1.Installation, error) {
	comps, err := getInstallationComponents(ctx, client)
	if err != nil {
