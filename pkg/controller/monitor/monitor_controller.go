...
func (r *ReconcileMonitor) Reconcile(ctx context.Context, request reconcile.Request) (reconcile.Result, error) {
	...
	// monitor the health of calico-prometheus-operator deployment.
	r.status.AddDeployments([]types.NamespacedName{{Name: "calico-prometheus-operator", Namespace: common.TigeraPrometheusNamespace}})
