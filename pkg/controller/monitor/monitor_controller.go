...
func (r *ReconcileMonitor) readAlertmanagerConfig(ctx context.Context, uiAlertsEnabled bool) (*monitoringv1beta1.AlertmanagerConfig, error) {
	userConfig := &monitoringv1beta1.AlertmanagerConfig{}
	...
	return &monitoringv1beta1.AlertmanagerConfig{
