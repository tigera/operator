...
var _ = Describe("Monitor controller tests", func() {
	...
	Context("Alertmanager Configuration", func() {
		...
		It("should use a user-provided AlertmanagerConfig from the operator namespace", func() {
			...
			Expect(cli.Create(ctx, &monitoringv1beta1.AlertmanagerConfig{
				...
				Spec: monitoringv1beta1.AlertmanagerConfigSpec{
					Route:     &monitoringv1beta1.Route{Receiver: userReceiver},
					Receivers: []monitoringv1beta1.Receiver{{Name: userReceiver}},
				},
			})).NotTo(HaveOccurred())
