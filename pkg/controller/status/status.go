...
// This regex matches any characters not allows at the start of a Status Reason
var reasonInvalidStartCharacters = regexp.MustCompile(`^[^A-Za-z]*`)

// This regex matches any characters not allows at the end of a Status Reason
