...
var _ = Describe("Status reporting tests", func() {
	...
	It("should contain all the NamespacesNames for all the resources added by multiple calls to Set<Resources>", func() {
		sm.SetStatefulSets([]types.NamespacedName{{Namespace: "NS1", Name: "SS1"}})
		sm.SetStatefulSets([]types.NamespacedName{{Namespace: "NS1", Name: "SS2"}})
		sm.SetDeployments([]types.NamespacedName{{Namespace: "NS1", Name: "DP1"}})
		sm.SetDeployments([]types.NamespacedName{{Namespace: "NS1", Name: "DP2"}})
		sm.SetDaemonsets([]types.NamespacedName{{Namespace: "NS1", Name: "DS1"}})
		sm.SetDaemonsets([]types.NamespacedName{{Namespace: "NS1", Name: "DS2"}})
		sm.SetCronJobs([]types.NamespacedName{{Namespace: "NS1", Name: "CJ1"}})
		sm.SetCronJobs([]types.NamespacedName{{Namespace: "NS1", Name: "CJ2"}})
	...
	It("should not contain the NamespacedNames for resources removed by calls to Remove<Resource", func() {
		sm.SetStatefulSets([]types.NamespacedName{
			{Namespace: "NS1", Name: "SS1"},
			{Namespace: "NS1", Name: "SS2"},
		})
		sm.SetDeployments([]types.NamespacedName{
			{Namespace: "NS1", Name: "DP1"},
			{Namespace: "NS1", Name: "DP2"},
		})
		sm.SetDaemonsets([]types.NamespacedName{
			{Namespace: "NS1", Name: "DS1"},
			{Namespace: "NS1", Name: "DS2"},
		})
		sm.SetCronJobs([]types.NamespacedName{
