...
var _ = Describe("Status reporting tests", func() {
	...
	DescribeTable("test sanitizeReason",
		...
		Entry("ES example message with comma",
		...
		Entry("Example message with slash",
			"failed to retrieve / validate  ",
			"failed_to_retrieve___validate__"),
		Entry("Example message with period",
			"Failed to process the authentication CR.", "Failed_to_process_the_authentication_CR_"),
