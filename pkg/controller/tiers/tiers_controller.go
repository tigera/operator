...
func (r *ReconcileTiers) Reconcile(ctx context.Context, request reconcile.Request) (reconcile.Result, error) {
	...
	tiersConfig, requeue := r.prepareTiersConfig(ctx, reqLogger)
	if requeue {
		return reconcile.Result{RequeueAfter: 10 * time.Second}, nil
	}
...
func (r *ReconcileTiers) prepareTiersConfig(ctx context.Context, reqLogger logr.Logger) (*tiers.Config /*requeue*/, bool) {
