...
func newReconciler(mgr manager.Manager) reconcile.Reconciler {
	r := &ReconcileTunnel{
		...
		provider: p,
		status:   status.New(mgr.GetClient(), "tunnel"),
	}
	r.status.Run()
	return r
}
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &operatorv1.Tunnel{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
...
func newPodForCR(cr *operatorv1.Tunnel) *corev1.Pod {
