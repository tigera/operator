...
// in-place.
func copyAllowedMetadata(metadataKeys AllowedMetadaKeys, current, desired *metav1.ObjectMeta) {
	desired.Annotations = mergeAnnotationsOrLabels(metadataKeys.Annotations, current.Annotations, desired.Annotations)
	desired.Labels = mergeAnnotationsOrLabels(metadataKeys.Labels, current.Labels, desired.Labels)
	return
}
