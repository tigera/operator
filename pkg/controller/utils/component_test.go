...
var _ = Describe("Component handler tests", func() {
	...
	It("merges annotations and reconciles only operator added annotations", func() {
		fc := &fakeComponent{
			supportedOSTypes: []render.OSType{render.OSTypeLinux},
...
type fakeComponent struct {
	objs             []runtime.Object
	supportedOSTypes []render.OSType
}
...
func (c *fakeComponent) SupportedOSTypes() []render.OSType {
	return c.supportedOSTypes
}
