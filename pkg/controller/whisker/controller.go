...
func (r *Reconciler) Reconcile(ctx context.Context, request reconcile.Request) (reconcile.Result, error) {
	...
	// treat it like an unset spec and tear any existing resources down. The
	// health read-back below shares this condition — gating the two differently
	// leaves the component degraded over a gateway it never rendered.
