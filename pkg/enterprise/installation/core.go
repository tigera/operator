...
// DeclareFelixConfiguration declares the Enterprise-only FelixConfiguration defaults. Some
// platforms run a DNS service that isn't named "kube-dns", so dnsTrustedServers needs a
// provider-specific default for Enterprise DNS logging to work.
