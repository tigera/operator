...
func ApplyExtensions[Cfg any](d extensions.Decorator, key render.ModifierKey[Cfg], ri render.Inputs, create, del []client.Object) ([]client.Object, []client.Object) {
	var zero Cfg
	return ApplyExtensionsWithInputs(d, key, ri, zero, create, del)
}
...
func ApplyExtensionsWithInputs[Cfg any](d extensions.Decorator, key render.ModifierKey[Cfg], ri render.Inputs, extIn Cfg, create, del []client.Object) ([]client.Object, []client.Object) {
	stub := StubComponent{Key: key.String(), ExtIn: extIn, Create: create, Delete: del}
	return d.Decorate(stub, ri).Objects()
}
