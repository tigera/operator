...
var _ = Describe("API server rendering tests (Calico Enterprise)", func() {
	...
	DescribeTable("should render an API server with default configuration", func(clusterDomain string) {
		expectedResources := []client.Object{
			...
			&rbacv1.ClusterRole{ObjectMeta: metav1.ObjectMeta{Name: "calico-ee-tiered-policy-passthrough"}, TypeMeta: metav1.TypeMeta{Kind: "ClusterRole", APIVersion: "rbac.authorization.k8s.io/v1"}},
			&rbacv1.ClusterRoleBinding{ObjectMeta: metav1.ObjectMeta{Name: "calico-ee-tiered-policy-passthrough"}, TypeMeta: metav1.TypeMeta{Kind: "ClusterRoleBinding", APIVersion: "rbac.authorization.k8s.io/v1"}},
	...
	It("should render an API server with custom configuration with MCM enabled at restart", func() {
		...
		expected := []client.Object{
			...
			&rbacv1.ClusterRole{ObjectMeta: metav1.ObjectMeta{Name: "calico-ee-tiered-policy-passthrough"}},
			&rbacv1.ClusterRoleBinding{ObjectMeta: metav1.ObjectMeta{Name: "calico-ee-tiered-policy-passthrough"}},
