...
var _ = Describe("API server rendering tests (Calico Enterprise)", func() {
	...
	DescribeTable("should render an API server with default configuration", func(clusterDomain string) {
		...
		Expect(d.Spec.Template.Spec.Containers[0].LivenessProbe.PeriodSeconds).To(BeEquivalentTo(60))
		Expect(d.Spec.Template.Spec.Containers[0].LivenessProbe.TimeoutSeconds).To(BeEquivalentTo(5))
		...
		Expect(d.Spec.Template.Spec.Containers[1].LivenessProbe.PeriodSeconds).To(BeEquivalentTo(60))
		Expect(d.Spec.Template.Spec.Containers[1].LivenessProbe.TimeoutSeconds).To(BeEquivalentTo(10))
