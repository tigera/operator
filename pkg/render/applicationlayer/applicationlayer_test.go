...
var _ = Describe("Tigera Secure Application Layer rendering tests", func() {
	...
	It("should render with default l7 collector configuration", func() {
		expectedResources := []struct {
			...
			{name: applicationlayer.AppSecDaemonsetName, ns: common.CalicoNamespace, group: "apps", version: "v1", kind: "DaemonSet"},
		}
		...
		ds := rtest.GetResource(resources, applicationlayer.AppSecDaemonsetName, common.CalicoNamespace, "apps", "v1", "DaemonSet").(*appsv1.DaemonSet)
