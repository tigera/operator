...
const (
	httpsEndpoint     = "https://tigera-secure-es-gateway-http.tigera-kibana.svc:5601"
	httpsFQDNEndpoint = "https://tigera-secure-es-gateway-http.tigera-kibana.svc.%s:5601"
)
