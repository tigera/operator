		...
		Spec: ElasticsearchPodSpecDecorate(corev1.PodSpec{
			...
			Containers: []corev1.Container{
				ElasticsearchContainerDecorate(corev1.Container{
					Name:          "compliance-controller",
					Image:         components.GetImageReference(components.ComplianceControllerImage, c.installation.Spec.Registry),
					Env:           envVars,
			...
			Spec: ElasticsearchPodSpecDecorate(corev1.PodSpec{
				...
				Containers: []corev1.Container{
					ElasticsearchContainerDecorateIndexCreator(
						ElasticsearchContainerDecorate(corev1.Container{
							Name:          "reporter",
							Image:         components.GetImageReference(components.ComplianceReporterImage, c.installation.Spec.Registry),
							Env:           envVars,
							LivenessProbe: complianceLivenessProbe,
	...
	podTemplate := ElasticsearchDecorateAnnotations(&corev1.PodTemplateSpec{
		...
		Spec: ElasticsearchPodSpecDecorate(corev1.PodSpec{
			...
			Containers: []corev1.Container{
				ElasticsearchContainerDecorate(corev1.Container{
					Name:  "compliance-server",
					Image: components.GetImageReference(components.ComplianceServerImage, c.installation.Spec.Registry),
					Env:   envVars,
		...
		Spec: ElasticsearchPodSpecDecorate(corev1.PodSpec{
			...
			Containers: []corev1.Container{
				ElasticsearchContainerDecorateIndexCreator(
					ElasticsearchContainerDecorate(corev1.Container{
						Name:          "compliance-snapshotter",
						Image:         components.GetImageReference(components.ComplianceSnapshotterImage, c.installation.Spec.Registry),
						Env:           envVars,
						LivenessProbe: complianceLivenessProbe,
		...
		Spec: ElasticsearchPodSpecDecorate(corev1.PodSpec{
			...
			Containers: []corev1.Container{
				ElasticsearchContainerDecorateIndexCreator(
					ElasticsearchContainerDecorate(corev1.Container{
						Name:          "compliance-benchmarker",
						Image:         components.GetImageReference(components.ComplianceBenchmarkerImage, c.installation.Spec.Registry),
						Env:           envVars,
