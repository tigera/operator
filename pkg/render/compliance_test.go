...
var _ = Describe("compliance rendering tests", func() {
	...
	Describe("node selection & affinity", func() {
		...
		It("should apply controlPlaneTolerations", func() {
			...
			Expect(dpComplianceServer.Spec.Template.Spec.Tolerations).To(ContainElements(append(rmeta.TolerateMaster, t)))
			Expect(dpComplianceController.Spec.Template.Spec.Tolerations).To(ContainElements(append(rmeta.TolerateMaster, t)))
			Expect(complianceSnapshotter.Spec.Template.Spec.Tolerations).To(ContainElements(append(rmeta.TolerateMaster, t)))
			Expect(complianceReporter.Template.Spec.Tolerations).To(ContainElements(append(rmeta.TolerateMaster, t)))
