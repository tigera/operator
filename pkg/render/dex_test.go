	...
	Context("dex is configured for oidc", func() {
		...
		Context("when SecretProviderClass is provided", func() {
			...
			BeforeEach(func() {
				...
				cfg.DexConfig = render.NewDexConfig(cfg.Installation.CertificateManagement, authentication, dexSecret, nil, secretProviderClass, clusterName)
			...
			It("should render resources using SecretProviderClass", func() {
				...
				Expect(rtest.GetResource(toDelete, render.OIDCSecretName, common.OperatorNamespace(), "", "v1", "Secret")).NotTo(BeNil())
		...
		It("should switch from Kubernetes Secret to SecretProviderClass", func() {
			...
			Expect(rtest.GetResource(toDelete, render.OIDCSecretName, common.OperatorNamespace(), "", "v1", "Secret")).To(BeNil())
			...
			cfg.DexConfig = render.NewDexConfig(cfg.Installation.CertificateManagement, authentication, dexSecret, nil, spc, clusterName)
