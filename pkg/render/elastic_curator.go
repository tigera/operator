...
func (ec elasticCuratorComponent) envVars() []corev1.EnvVar {
	return []corev1.EnvVar{
		...
		{Name: "EE_MAX_TOTAL_STORAGE_PCT", Value: fmt.Sprint(*ec.logStorage.Spec.Retention.MaxTotalStoragePercent)},
		{Name: "EE_MAX_LOGS_STORAGE_PCT", Value: fmt.Sprint(*ec.logStorage.Spec.Retention.MaxLogsStoragePercent)},
	}
}
