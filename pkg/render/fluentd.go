...
func (c *fluentdComponent) envvars() []corev1.EnvVar {
	envs := []corev1.EnvVar{
		...
		//{Name: "LINSEED_CLIENT_CERT", Value: "/etc/certs/tls.crt"},
		//{Name: "LINSEED_CLIENT_KEY", Value: "/etc/certs/tls.key"},
		//{Name: "LINSEED_TOKEN", Value: "sample"},
	...
	if c.cfg.ManagedCluster {
		...
		egressRules = append(egressRules, v3.Rule{
			...
			Destination: v3.EntityRule{
				...
				NotPorts:          networkpolicy.Ports(443),
			},
		})
