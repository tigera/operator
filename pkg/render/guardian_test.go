...
var _ = Describe("Rendering tests", func() {
	...
	Context("Guardian component", func() {
		...
		It("should render all resources for a managed cluster", func() {
			expectedResources := []client.Object{
				...
				&rbacv1.Role{ObjectMeta: metav1.ObjectMeta{Name: render.GuardianSecretsRole}, TypeMeta: metav1.TypeMeta{Kind: "Role", APIVersion: "rbac.authorization.k8s.io/v1"}},
				&rbacv1.RoleBinding{ObjectMeta: metav1.ObjectMeta{Name: render.GuardianSecretsRoleBindingName}, TypeMeta: metav1.TypeMeta{Kind: "RoleBinding", APIVersion: "rbac.authorization.k8s.io/v1"}},
	...
	Context("GuardianPolicy component", func() {
		...
		Context("allow-tigera rendering", func() {
			policyName := types.NamespacedName{Name: "allow-tigera.guardian-access", Namespace: "calico-system"}
