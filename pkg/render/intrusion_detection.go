...
func (c *intrusionDetectionComponent) adAPIDeployment() *appsv1.Deployment {
	...
	mounts = append(mounts, c.cfg.ADAPIServerCertSecret.VolumeMount(c.SupportedOSType()))
	mounts = append(mounts, corev1.VolumeMount{MountPath: adAPIStoragePath, Name: adAPIStorageVolumeName, ReadOnly: false})
