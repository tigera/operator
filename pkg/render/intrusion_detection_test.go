...
var _ = Describe("Intrusion Detection rendering tests", func() {
	It("should render all resources for a default configuration", func() {
		...
		component := render.IntrusionDetection(nil, nil, nil, &corev1.Secret{ObjectMeta: metav1.ObjectMeta{Name: render.TigeraKibanaCertSecret}}, &operatorv1.InstallationSpec{Registry: "testregistry.com/"}, esConfigMap, nil, notOpenshift, dns.DefaultClusterDomain, render.ElasticsearchLicenseTypeUnknown, notManagedCluster, false, &internalManagerTLSSecret, false, nil, nil, nil)
	...
	It("should render all resources for a configuration that includes event forwarding turned on (Syslog)", func() {
		...
		component := render.IntrusionDetection(nil, lc, nil, &corev1.Secret{ObjectMeta: metav1.ObjectMeta{Name: render.TigeraKibanaCertSecret}}, &operatorv1.InstallationSpec{Registry: "testregistry.com/"}, esConfigMap, nil, notOpenshift, dns.DefaultClusterDomain, render.ElasticsearchLicenseTypeUnknown, notManagedCluster, false, nil, false, nil, nil, nil)
		resources, _ := component.Objects()
	...
	It("should render all resources for deep packet inspection", func() {
		...
		component := render.IntrusionDetection(ids, nil, nil, &corev1.Secret{ObjectMeta: metav1.ObjectMeta{Name: render.TigeraKibanaCertSecret}}, &operatorv1.InstallationSpec{Registry: "testregistry.com/"}, esConfigMap, nil, notOpenshift, dns.DefaultClusterDomain, render.ElasticsearchLicenseTypeUnknown, notManagedCluster, false, &internalManagerTLSSecret, true, nodeTLSSecret, typhaTLSSecret, typhaCAConfigMap)
		resources, _ := component.Objects()
	...
	It("should not render intrusion-detection-es-job-installer and should disable GlobalAlert controller when cluster is managed", func() {
		...
		component := render.IntrusionDetection(nil, nil, nil, &corev1.Secret{ObjectMeta: metav1.ObjectMeta{Name: render.TigeraKibanaCertSecret}}, &operatorv1.InstallationSpec{Registry: "testregistry.com/"}, esConfigMap, nil, notOpenshift, dns.DefaultClusterDomain, render.ElasticsearchLicenseTypeUnknown, managedCluster, false, nil, false, nil, nil, nil)
		resources, _ := component.Objects()
	...
	It("should apply controlPlaneNodeSelector correctly", func() {
		component := render.IntrusionDetection(nil, nil, nil, &corev1.Secret{ObjectMeta: metav1.ObjectMeta{Name: render.TigeraKibanaCertSecret}}, &operatorv1.InstallationSpec{
			ControlPlaneNodeSelector: map[string]string{"foo": "bar"},
		}, &relasticsearch.ClusterConfig{}, nil, false, dns.DefaultClusterDomain, render.ElasticsearchLicenseTypeUnknown, notManagedCluster, false, nil, false, nil, nil, nil)
		resources, _ := component.Objects()
		idc := rtest.GetResource(resources, "intrusion-detection-controller", render.IntrusionDetectionNamespace, "apps", "v1", "Deployment").(*appsv1.Deployment)
