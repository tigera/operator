...
var _ = Describe("Intrusion Detection rendering tests", func() {
	...
	It("should render all resources for a default configuration", func() {
		...
		expectedResources := []struct {
			...
			{name: "tigera.io.adjobs.ip_sweep", ns: "", group: "projectcalico.org", version: "v3", kind: "GlobalAlertTemplate"},
			{name: "tigera.io.adjobs.port_scan", ns: "", group: "projectcalico.org", version: "v3", kind: "GlobalAlertTemplate"},
			{name: "tigera.io.adjobs.bytes_in", ns: "", group: "projectcalico.org", version: "v3", kind: "GlobalAlertTemplate"},
			{name: "tigera.io.adjobs.bytes_out", ns: "", group: "projectcalico.org", version: "v3", kind: "GlobalAlertTemplate"},
			{name: "tigera.io.adjobs.process_restarts", ns: "", group: "projectcalico.org", version: "v3", kind: "GlobalAlertTemplate"},
			{name: "tigera.io.adjobs.dns_latency", ns: "", group: "projectcalico.org", version: "v3", kind: "GlobalAlertTemplate"},
			{name: "tigera.io.adjobs.l7_latency", ns: "", group: "projectcalico.org", version: "v3", kind: "GlobalAlertTemplate"},
			{name: "tigera.io.adjobs.http_connection_spike", ns: "", group: "projectcalico.org", version: "v3", kind: "GlobalAlertTemplate"},
