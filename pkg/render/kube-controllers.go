...
func KubeControllers(
	...
	kubeControllersVerificationSecret *v1.Secret,
	...
	hashedUserSecret := kubeControllersVerificationSecret
	if hashedUserSecret == nil {
		hashedPassword, _ := bcrypt.GenerateFromPassword(kubeControllersUserSecret.Data["password"], bcrypt.MinCost)
		hashedUserSecret = &v1.Secret{
			ObjectMeta: metav1.ObjectMeta{
				Name:      ElasticsearchKubeControllersVerificationUserSecret,
