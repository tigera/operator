...
func (es *elasticsearchComponent) Objects() ([]client.Object, []client.Object) {
	...
	if es.managementClusterConnection == nil {
		...
		toCreate = append(toCreate,
			createNamespace(ECKOperatorNamespace, es.provider),
		)
		...
		// Elasticsearch CRs
		toCreate = append(toCreate, createNamespace(ElasticsearchNamespace, es.provider))
		...
		// Kibana CRs
		toCreate = append(toCreate, createNamespace(KibanaNamespace, operatorv1.ProviderNone))
		...
		toCreate = append(toCreate,
			createNamespace(ElasticsearchNamespace, es.provider),
			createNamespace(KibanaNamespace, es.provider),
