...
func EsGateway(
	...
	kubeControllersSecret *corev1.Secret,
	...
	if esAdminUserSecret != nil {
		...
		TLSSecrets = append(TLSSecrets, ElasticsearchUserSecret)
	}
	...
	cert := TLSSecret.Data[SecretCertName]
	...
	esGatewayElasticCertSecret.Data = map[string][]byte{SecretCertName: cert}
	...
	TLSSecrets = append(TLSSecrets, secret.CopyToNamespace(render.ElasticsearchNamespace, kibanaPublicCertSecret)...)
	...
	return &esGateway{
		...
		kubeControllersSecret:   kubeControllersSecret,
...
func (e *esGateway) Objects() (toCreate, toDelete []client.Object) {
	...
	toCreate = append(toCreate, e.Role())
	toCreate = append(toCreate, e.RoleBinding())
...
func (e esGateway) Role() *rbacv1.Role {
	return &rbacv1.Role{
...
func (e esGateway) RoleBinding() *rbacv1.RoleBinding {
...
func (e esGateway) esGatewayDeployment() *appsv1.Deployment {
	...
	envVars := []corev1.EnvVar{
		...
		{Name: "ES_GATEWAY_ELASTIC_ADMIN_DUMMY_USERNAME", Value: string(e.kubeControllersSecret.Data["username"])},
		{Name: "ES_GATEWAY_ELASTIC_ADMIN_DUMMY_PASSWORD", Value: string(e.kubeControllersSecret.Data["password"])},
		{
