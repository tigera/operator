...
func EsGateway(
	...
	if esAdminUserSecret != nil {
		...
		tlsAnnotations[render.ElasticsearchTLSHashAnnotation] = rmeta.SecretsAnnotationHash(esAdminUserSecret, tlsSecret, esInternalCertSecret)
	} else {
		tlsAnnotations[render.ElasticsearchTLSHashAnnotation] = rmeta.SecretsAnnotationHash(tlsSecret, esInternalCertSecret)
	}
