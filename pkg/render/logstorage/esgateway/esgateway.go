...
func (e esGateway) esGatewayDeployment() *appsv1.Deployment {
	envVars := []corev1.EnvVar{
		...
		{Name: "ES_GATEWAY_ELASTIC_SWAP_ADMIN_USERNAME", Value: string(e.kubeControllersSecret.Data["username"])},
		{Name: "ES_GATEWAY_ELASTIC_SWAP_ADMIN_PASSWORD", Value: string(e.kubeControllersSecret.Data["password"])},
		{
