...
func EsGateway(
	...
	if esAdminUserSecret != nil {
		...
		tlsAnnotations[render.ElasticsearchTLSHashAnnotation] = rmeta.SecretsAnnotationHash(append(certSecrets, esAdminUserSecret, esInternalCertSecret)...)
	} else {
		tlsAnnotations[render.ElasticsearchTLSHashAnnotation] = rmeta.SecretsAnnotationHash(append(certSecrets, esInternalCertSecret)...)
	}
