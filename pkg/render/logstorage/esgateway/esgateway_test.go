	...
	Context("ES Gateway deployment", func() {
		...
		BeforeEach(func() {
			...
			cfg = &Config{
				...
				KubeControllersUserSecrets: []*corev1.Secret{
					{ObjectMeta: metav1.ObjectMeta{Name: enterprise.ElasticsearchKubeControllersUserSecret, Namespace: common.OperatorNamespace()}},
					{ObjectMeta: metav1.ObjectMeta{Name: enterprise.ElasticsearchKubeControllersVerificationUserSecret, Namespace: render.ElasticsearchNamespace}},
					{ObjectMeta: metav1.ObjectMeta{Name: enterprise.ElasticsearchKubeControllersSecureUserSecret, Namespace: render.ElasticsearchNamespace}},
				},
		...
		It("should render an ES Gateway deployment and all supporting resources", func() {
			expectedResources := []client.Object{
				...
				&corev1.Secret{ObjectMeta: metav1.ObjectMeta{Name: enterprise.ElasticsearchKubeControllersUserSecret, Namespace: common.OperatorNamespace()}},
				&corev1.Secret{ObjectMeta: metav1.ObjectMeta{Name: enterprise.ElasticsearchKubeControllersVerificationUserSecret, Namespace: render.ElasticsearchNamespace}},
				&corev1.Secret{ObjectMeta: metav1.ObjectMeta{Name: enterprise.ElasticsearchKubeControllersSecureUserSecret, Namespace: render.ElasticsearchNamespace}},
