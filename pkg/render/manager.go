...
func (c *managerComponent) Objects() ([]client.Object, []client.Object) {
	...
	if c.cfg.Manager.RBACManagementEnabled() && !c.cfg.Tenant.ManagedClusterIsCalico() {
...
// the RBAC management UI's Secret/ConfigMap access to the manager namespace.
func (c *managerComponent) rbacManagementUINamespacedRole() []client.Object {
	return []client.Object{
		&rbacv1.Role{
			TypeMeta:   metav1.TypeMeta{Kind: "Role", APIVersion: "rbac.authorization.k8s.io/v1"},
			ObjectMeta: metav1.ObjectMeta{Name: ManagerClusterRole, Namespace: c.cfg.Namespace},
			Rules: []rbacv1.PolicyRule{
				{
					APIGroups: []string{""},
