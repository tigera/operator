...
func Manager(
	...
	if authKeyValidatorConfig != nil {
		tlsSecrets = append(tlsSecrets, authKeyValidatorConfig.RequiredSecrets(ManagerNamespace)...)
		tlsAnnotations = authKeyValidatorConfig.RequiredAnnotations()
	}
...
func (c *managerComponent) Objects() ([]client.Object, []client.Object) {
	...
	if c.authKeyValidatorConfig != nil {
		objs = append(objs, configmap.ToRuntimeObjects(c.authKeyValidatorConfig.RequiredConfigMaps(ManagerNamespace)...)...)
	}
...
func (c *managerComponent) managerVolumeMounts() []v1.VolumeMount {
	if c.authKeyValidatorConfig != nil {
		return c.authKeyValidatorConfig.RequiredVolumeMounts()
	}
...
func (c *managerComponent) managerVolumes() []v1.Volume {
	...
	if c.authKeyValidatorConfig != nil {
		v = append(v, c.authKeyValidatorConfig.RequiredVolumes()...)
	}
...
func (c *managerComponent) managerOAuth2EnvVars() []v1.EnvVar {
	...
	if c.authKeyValidatorConfig == nil {
		...
		envs = []corev1.EnvVar{
			...
			{Name: "CNX_WEB_OIDC_CLIENT_ID", Value: c.authKeyValidatorConfig.ClientID()}}

		switch c.authKeyValidatorConfig.(type) {
		case DexKeyValidatorConfig:
			envs = append(envs, corev1.EnvVar{Name: "CNX_WEB_OIDC_AUTHORITY", Value: c.authKeyValidatorConfig.Issuer()})
		case authentication.KeyValidatorConfig:
...
func (c *managerComponent) managerProxyContainer() corev1.Container {
	...
	if c.authKeyValidatorConfig != nil {
		env = append(env, c.authKeyValidatorConfig.RequiredEnv("VOLTRON_")...)
	}
	...
	return corev1.Container{
		Name:            VoltronName,
		Image:           "gcr.io/tigera-dev/experimental/brianmcmahon/tigera/voltron:latest", //todo: revert
...
func (c *managerComponent) managerEsProxyContainer() corev1.Container {
	...
	if c.authKeyValidatorConfig != nil {
		env = append(env, c.authKeyValidatorConfig.RequiredEnv("")...)
		volumeMounts = append(volumeMounts, c.authKeyValidatorConfig.RequiredVolumeMounts()...)
	}

	return corev1.Container{
		Name:            "tigera-es-proxy",
		Image:           "gcr.io/tigera-dev/experimental/brianmcmahon/tigera/es-proxy:latest",
		ImagePullPolicy: "Always",
