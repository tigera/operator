...
func (c *managerComponent) managerEnvVars() []corev1.EnvVar {
	envs := []corev1.EnvVar{
		...
		{Name: "ENABLE_COMPLIANCE_REPORTS", Value: strconv.FormatBool(c.cfg.ComplianceEnabled)},
	}
...
func (c *managerComponent) managerProxyContainer() corev1.Container {
	...
	env := []corev1.EnvVar{
		...
		{Name: "VOLTRON_ENABLE_COMPLIANCE", Value: strconv.FormatBool(c.cfg.ComplianceEnabled)},
	}
