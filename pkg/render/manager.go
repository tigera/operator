...
func (c *managerComponent) managerContainer() corev1.Container {
	tm := corev1.Container{
		Name:            "tigera-manager",
		Image:           components.GetReference(components.ComponentManager, c.registry, RefByDigest),
...
func (c *managerComponent) managerProxyContainer() corev1.Container {
	return corev1.Container{
		Name:  VoltronName,
		Image: components.GetReference(components.ComponentManagerProxy, c.registry, RefByDigest),
		Env: []corev1.EnvVar{
...
func (c *managerComponent) managerEsProxyContainer() corev1.Container {
	apiServer := corev1.Container{
		...
		Image:           components.GetReference(components.ComponentEsProxy, c.registry, RefByDigest),
