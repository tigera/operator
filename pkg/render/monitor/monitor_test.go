...
var _ = Describe("monitor rendering tests", func() {
	...
	It("Should render Prometheus resource Specs correctly", func() {
		...
		amConfigObj, ok := rtest.GetResource(toCreate, monitor.AlertmanagerConfigName, common.TigeraPrometheusNamespace, "monitoring.coreos.com", "v1beta1", monitoringv1beta1.AlertmanagerConfigKind).(*monitoringv1beta1.AlertmanagerConfig)
		Expect(ok).To(BeTrue())
...
func expectedBaseResources() []client.Object {
	return []client.Object{
		...
		&monitoringv1beta1.AlertmanagerConfig{ObjectMeta: metav1.ObjectMeta{Name: "calico-node-alertmanager", Namespace: common.TigeraPrometheusNamespace}, TypeMeta: metav1.TypeMeta{Kind: "AlertmanagerConfig", APIVersion: "monitoring.coreos.com/v1beta1"}},
		...
		&rbacv1.ClusterRole{ObjectMeta: metav1.ObjectMeta{Name: "tigera-alertmanager-linseed"}, TypeMeta: metav1.TypeMeta{Kind: "ClusterRole", APIVersion: "rbac.authorization.k8s.io/v1"}},
		&rbacv1.ClusterRoleBinding{ObjectMeta: metav1.ObjectMeta{Name: "tigera-alertmanager-linseed"}, TypeMeta: metav1.TypeMeta{Kind: "ClusterRoleBinding", APIVersion: "rbac.authorization.k8s.io/v1"}},
