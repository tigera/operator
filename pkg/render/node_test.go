...
var _ = Describe("Node rendering tests", func() {
	...
	It("should render all resources for a default configuration", func() {
		...
		component := render.Node(k8sServiceEp, defaultInstance, nil, typhaNodeTLS, nil, false, "", defaultClusterDomain, 0, "", nil, false)
  ...
  "plugins": [
	...
	It("should render all resources for a default configuration using TigeraSecureEnterprise", func() {
		...
		component := render.Node(k8sServiceEp, defaultInstance, nil, typhaNodeTLS, nil, false, "", defaultClusterDomain, 9081, "", nil, false)
		Expect(component.ResolveImages(nil)).To(BeNil())
		resources, _ := component.Objects()
		Expect(len(resources)).To(Equal(len(expectedResources)))
  ...
  "plugins": [
	...
	It("should properly render a configuration using the AmazonVPC CNI plugin", func() {
		...
		component := render.Node(k8sServiceEp, amazonVPCInstalllation, nil, typhaNodeTLS, nil, false, "", defaultClusterDomain, 0, "", nil, false)
		Expect(component.ResolveImages(nil)).To(BeNil())
		resources, _ := component.Objects()
	...
	DescribeTable("should properly render configuration using non-Calico CNI plugin",
		func(cni operator.CNIPluginType, ipam operator.IPAMPluginType, expectedEnvs []v1.EnvVar) {
			...
			component := render.Node(k8sServiceEp, installlation, nil, typhaNodeTLS, nil, false, "", defaultClusterDomain, 0, "", nil, false)
			Expect(component.ResolveImages(nil)).To(BeNil())
			resources, _ := component.Objects()
  ...
  "plugins": [
	...
	It("should render volumes and node volumemounts when bird templates are provided", func() {
		...
		defaultInstance.KubernetesProvider = operator.ProviderOpenShift
		component := render.Node(k8sServiceEp, defaultInstance, bt, typhaNodeTLS, nil, false, "", defaultClusterDomain, 0, "", nil, false)
		Expect(component.ResolveImages(nil)).To(BeNil())
		resources, _ := component.Objects()
		Expect(len(resources)).To(Equal(len(expectedResources)))
	...
	It("should include updates needed for the core upgrade", func() {
		defaultInstance.KubernetesProvider = operator.ProviderOpenShift
		component := render.Node(k8sServiceEp, defaultInstance, nil, typhaNodeTLS, nil, true, "", defaultClusterDomain, 0, "", nil, false)
		Expect(component.ResolveImages(nil)).To(BeNil())
		resources, _ := component.Objects()
  ...
  "plugins": [
	...
	It("should render seccomp profiles", func() {
		...
		component := render.Node(k8sServiceEp, defaultInstance, nil, typhaNodeTLS, nil, false, seccompProf, defaultClusterDomain, 0, "", nil, false)
		Expect(component.ResolveImages(nil)).To(BeNil())
		resources, _ := component.Objects()
	...
	It("should set TIGERA_*_SECURITY_GROUP variables when AmazonCloudIntegration is defined", func() {
		...
		component := render.Node(k8sServiceEp, defaultInstance, nil, typhaNodeTLS, aci, false, "", defaultClusterDomain, 0, "", nil, false)
		Expect(component.ResolveImages(nil)).To(BeNil())
		resources, _ := component.Objects()
  ...
  "plugins": [
	...
	It("should handle BGP layout", func() {
		component := render.Node(k8sServiceEp, defaultInstance, nil, typhaNodeTLS, nil, false, "", defaultClusterDomain, 0, "bgp-layout-hash", nil, false)
		resources, _ := component.Objects()
