...
var _ = Describe("GatewayAPI tests", func() {
	...
	It("deploys the controller into calico-system in GatewayNamespace mode", func() {
		By("Creating Installation")
		instance := &operator.Installation{
			TypeMeta:   metav1.TypeMeta{Kind: "Installation", APIVersion: "operator.tigera.io/v1"},
			ObjectMeta: metav1.ObjectMeta{Name: "default"},
		...
		By("Creating a GatewayAPI with GatewayDeploymentMode=GatewayNamespace")
		mode := operator.GatewayDeploymentModeGatewayNamespace
		gatewayAPI := &operator.GatewayAPI{
			TypeMeta:   metav1.TypeMeta{Kind: "GatewayAPI", APIVersion: "operator.tigera.io/v1"},
			ObjectMeta: metav1.ObjectMeta{Name: "tigera-secure"},
			Spec:       operator.GatewayAPISpec{GatewayDeploymentMode: &mode},
		}
	...
	It("provisions and cleans up per-namespace resources in GatewayNamespace mode", func() {
	...
	It("cleans up GatewayClass and EnvoyProxy resources when no longer wanted (GatewayNamespace mode)", func() {
		By("Creating Installation")
		instance := &operator.Installation{
			TypeMeta:   metav1.TypeMeta{Kind: "Installation", APIVersion: "operator.tigera.io/v1"},
			ObjectMeta: metav1.ObjectMeta{Name: "default"},
		...
		By("Creating the default GatewayAPI in GatewayNamespace mode")
		mode := operator.GatewayDeploymentModeGatewayNamespace
		gatewayAPI := &operator.GatewayAPI{
			TypeMeta:   metav1.TypeMeta{Kind: "GatewayAPI", APIVersion: "operator.tigera.io/v1"},
			ObjectMeta: metav1.ObjectMeta{Name: "tigera-secure"},
	...
	It("watches custom EnvoyProxy resources (GatewayNamespace mode)", func() {
		By("Creating Installation")
		instance := &operator.Installation{
			TypeMeta:   metav1.TypeMeta{Kind: "Installation", APIVersion: "operator.tigera.io/v1"},
			ObjectMeta: metav1.ObjectMeta{Name: "default"},
	...
	It("creates EnvoyProxy with owning gateway env vars in l7-log-collector (GatewayNamespace mode)", func() {
		By("Creating Installation")
		instance := &operator.Installation{
			TypeMeta:   metav1.TypeMeta{Kind: "Installation", APIVersion: "operator.tigera.io/v1"},
			ObjectMeta: metav1.ObjectMeta{Name: "default"},
	...
	It("watches the custom EnvoyGateway ConfigMap (GatewayNamespace mode)", func() {
		By("Creating Installation")
		instance := &operator.Installation{
			TypeMeta:   metav1.TypeMeta{Kind: "Installation", APIVersion: "operator.tigera.io/v1"},
			ObjectMeta: metav1.ObjectMeta{Name: "default"},
		...
		By("Creating GatewayAPI in GatewayNamespace mode with an EnvoyGatewayConfigRef that doesn't exist yet")
		mode := operator.GatewayDeploymentModeGatewayNamespace
		gatewayAPI := &operator.GatewayAPI{
			TypeMeta:   metav1.TypeMeta{Kind: "GatewayAPI", APIVersion: "operator.tigera.io/v1"},
			ObjectMeta: metav1.ObjectMeta{Name: "tigera-secure"},
